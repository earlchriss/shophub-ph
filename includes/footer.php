    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 mb-4">
                <h5><i class="fas fa-bolt me-2"></i>ElectroShop</h5>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <p class="mb-0">&copy; 2024 ElectroShop. All rights reserved.</p>
            </div>
...
<script>
    function selectShipping(element) {
        ...
        const fee = shippingFees[radio.value];
    ...
    function updateTotal() {
        const subtotal = 168997;
        const discount = 2000;
        const shippingFee = parseInt(document.getElementById('shipping-fee').textContent.replace('₱', ''));
